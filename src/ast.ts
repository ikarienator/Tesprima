...
module TypedEsprima {
  ...
  TokenName[TokenType.BooleanLiteral] = 'Boolean';
  TokenName[TokenType.EOF] = '<end>';
  TokenName[TokenType.Identifier] = 'Identifier';
  TokenName[TokenType.Keyword] = 'Keyword';
  TokenName[TokenType.NullLiteral] = 'Null';
  TokenName[TokenType.NumericLiteral] = 'Numeric';
  TokenName[TokenType.Punctuator] = 'Punctuator';
  TokenName[TokenType.StringLiteral] = 'String';
  TokenName[TokenType.RegularExpression] = 'RegularExpression';
