...
module TypedEsprima {
    export class ASTFactory {
        ...
        createArrayExpression(elements:Expression[]):ArrayExpression {
            return {
        ...
        createBreakStatement(label:string):BreakStatement {
            return {
        ...
        createContinueStatement(label:string):ContinueStatement {
            return {
